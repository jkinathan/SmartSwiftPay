...
class phpbb_cache_container extends \Symfony\Component\DependencyInjection\Container
{
    ...
    {
        return $this->services['config'] = new \phpbb\config\db(${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, ${($_ = isset($this->services['cache.driver']) ? $this->services['cache.driver'] : ($this->services['cache.driver'] = new \phpbb\cache\driver\file())) && false ?: '_'}, 'phpbbkt_config');
    }
    ...
    {
        return $this->services['config_text'] = new \phpbb\config\db_text(${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, 'phpbbkt_config_text');
    }
    ...
    {
        return $this->services['content.visibility'] = new \phpbb\content_visibility(${($_ = isset($this->services['auth']) ? $this->services['auth'] : ($this->services['auth'] = new \phpbb\auth\auth())) && false ?: '_'}, ${($_ = isset($this->services['config']) ? $this->services['config'] : $this->getConfigService()) && false ?: '_'}, ${($_ = isset($this->services['dispatcher']) ? $this->services['dispatcher'] : $this->getDispatcherService()) && false ?: '_'}, ${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, ${($_ = isset($this->services['user']) ? $this->services['user'] : $this->getUserService()) && false ?: '_'}, './', 'php', 'phpbbkt_forums', 'phpbbkt_posts', 'phpbbkt_topics', 'phpbbkt_users');
    }
    ...
    {
        $instance = new \phpbb\captcha\plugins\qa('phpbbkt_captcha_questions', 'phpbbkt_captcha_answers', 'phpbbkt_qa_confirm');
    ...
    {
        return $this->services['ext.manager'] = new \phpbb\extension\manager($this, ${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, ${($_ = isset($this->services['config']) ? $this->services['config'] : $this->getConfigService()) && false ?: '_'}, ${($_ = isset($this->services['filesystem']) ? $this->services['filesystem'] : ($this->services['filesystem'] = new \phpbb\filesystem\filesystem())) && false ?: '_'}, 'phpbbkt_ext', './', 'php', ${($_ = isset($this->services['cache']) ? $this->services['cache'] : $this->getCacheService()) && false ?: '_'});
    }
    ...
    {
        return new \phpbb\notification\method\email(${($_ = isset($this->services['user_loader']) ? $this->services['user_loader'] : $this->getUserLoaderService()) && false ?: '_'}, ${($_ = isset($this->services['user']) ? $this->services['user'] : $this->getUserService()) && false ?: '_'}, ${($_ = isset($this->services['config']) ? $this->services['config'] : $this->getConfigService()) && false ?: '_'}, ${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, './', 'php', 'phpbbkt_notification_emails');
    }
    ...
    {
        $instance = new \phpbb\notification\type\admin_activate_user(${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, ${($_ = isset($this->services['language']) ? $this->services['language'] : $this->getLanguageService()) && false ?: '_'}, ${($_ = isset($this->services['user']) ? $this->services['user'] : $this->getUserService()) && false ?: '_'}, ${($_ = isset($this->services['auth']) ? $this->services['auth'] : ($this->services['auth'] = new \phpbb\auth\auth())) && false ?: '_'}, './', 'php', 'phpbbkt_user_notifications');
    ...
    {
        return $this->services['profilefields.lang_helper'] = new \phpbb\profilefields\lang_helper(${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, 'phpbbkt_profile_fields_lang');
    }
    ...
    {
        return $this->services['text_formatter.data_access'] = new \phpbb\textformatter\data_access(${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, 'phpbbkt_bbcodes', 'phpbbkt_smilies', 'phpbbkt_styles', 'phpbbkt_words', './styles/');
    }
    ...
    {
        $this->services['text_reparser.forum_description'] = $instance = new \phpbb\textreparser\plugins\forum_description(${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, 'phpbbkt_forums');
    ...
    {
        $this->services['text_reparser.forum_rules'] = $instance = new \phpbb\textreparser\plugins\forum_rules(${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, 'phpbbkt_forums');
    ...
    {
        $this->services['text_reparser.group_description'] = $instance = new \phpbb\textreparser\plugins\group_description(${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, 'phpbbkt_groups');
    ...
    {
        $this->services['text_reparser.pm_text'] = $instance = new \phpbb\textreparser\plugins\pm_text(${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, 'phpbbkt_privmsgs');
    ...
    {
        $this->services['text_reparser.poll_option'] = $instance = new \phpbb\textreparser\plugins\poll_option(${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, 'phpbbkt_poll_options');
    ...
    {
        $this->services['text_reparser.poll_title'] = $instance = new \phpbb\textreparser\plugins\poll_title(${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, 'phpbbkt_topics');
    ...
    {
        $this->services['text_reparser.post_text'] = $instance = new \phpbb\textreparser\plugins\post_text(${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, 'phpbbkt_posts');
    ...
    {
        $this->services['text_reparser.user_signature'] = $instance = new \phpbb\textreparser\plugins\user_signature(${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, 'phpbbkt_users');
    ...
    {
        return $this->services['user_loader'] = new \phpbb\user_loader(${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, './', 'php', 'phpbbkt_users');
    }
    ...
    protected function getDefaultParameters()
    {
        return [
            ...
            'tables.acl_groups' => 'phpbbkt_acl_groups',
            'tables.acl_options' => 'phpbbkt_acl_options',
            'tables.acl_roles' => 'phpbbkt_acl_roles',
            'tables.acl_roles_data' => 'phpbbkt_acl_roles_data',
            'tables.acl_users' => 'phpbbkt_acl_users',
            'tables.attachments' => 'phpbbkt_attachments',
            'tables.auth_provider_oauth_token_storage' => 'phpbbkt_oauth_tokens',
            'tables.auth_provider_oauth_states' => 'phpbbkt_oauth_states',
            'tables.auth_provider_oauth_account_assoc' => 'phpbbkt_oauth_accounts',
            'tables.banlist' => 'phpbbkt_banlist',
            'tables.bbcodes' => 'phpbbkt_bbcodes',
            'tables.bookmarks' => 'phpbbkt_bookmarks',
            'tables.bots' => 'phpbbkt_bots',
            'tables.captcha_qa_questions' => 'phpbbkt_captcha_questions',
            'tables.captcha_qa_answers' => 'phpbbkt_captcha_answers',
            'tables.captcha_qa_confirm' => 'phpbbkt_qa_confirm',
            'tables.config' => 'phpbbkt_config',
            'tables.config_text' => 'phpbbkt_config_text',
            'tables.confirm' => 'phpbbkt_confirm',
            'tables.disallow' => 'phpbbkt_disallow',
            'tables.drafts' => 'phpbbkt_drafts',
            'tables.ext' => 'phpbbkt_ext',
            'tables.extensions' => 'phpbbkt_extensions',
            'tables.extension_groups' => 'phpbbkt_extension_groups',
            'tables.forums' => 'phpbbkt_forums',
            'tables.forums_access' => 'phpbbkt_forums_access',
            'tables.forums_track' => 'phpbbkt_forums_track',
            'tables.forums_watch' => 'phpbbkt_forums_watch',
            'tables.groups' => 'phpbbkt_groups',
            'tables.icons' => 'phpbbkt_icons',
            'tables.lang' => 'phpbbkt_lang',
            'tables.log' => 'phpbbkt_log',
            'tables.login_attempts' => 'phpbbkt_login_attempts',
            'tables.migrations' => 'phpbbkt_migrations',
            'tables.moderator_cache' => 'phpbbkt_moderator_cache',
            'tables.modules' => 'phpbbkt_modules',
            'tables.notification_emails' => 'phpbbkt_notification_emails',
            'tables.notification_types' => 'phpbbkt_notification_types',
            'tables.notifications' => 'phpbbkt_notifications',
            'tables.poll_options' => 'phpbbkt_poll_options',
            'tables.poll_votes' => 'phpbbkt_poll_votes',
            'tables.posts' => 'phpbbkt_posts',
            'tables.privmsgs' => 'phpbbkt_privmsgs',
            'tables.privmsgs_folder' => 'phpbbkt_privmsgs_folder',
            'tables.privmsgs_rules' => 'phpbbkt_privmsgs_rules',
            'tables.privmsgs_to' => 'phpbbkt_privmsgs_to',
            'tables.profile_fields' => 'phpbbkt_profile_fields',
            'tables.profile_fields_data' => 'phpbbkt_profile_fields_data',
            'tables.profile_fields_options_language' => 'phpbbkt_profile_fields_lang',
            'tables.profile_fields_language' => 'phpbbkt_profile_lang',
            'tables.ranks' => 'phpbbkt_ranks',
            'tables.reports' => 'phpbbkt_reports',
            'tables.reports_reasons' => 'phpbbkt_reports_reasons',
            'tables.search_results' => 'phpbbkt_search_results',
            'tables.search_wordlist' => 'phpbbkt_search_wordlist',
            'tables.search_wordmatch' => 'phpbbkt_search_wordmatch',
            'tables.sessions' => 'phpbbkt_sessions',
            'tables.sessions_keys' => 'phpbbkt_sessions_keys',
            'tables.sitelist' => 'phpbbkt_sitelist',
            'tables.smilies' => 'phpbbkt_smilies',
            'tables.sphinx' => 'phpbbkt_sphinx',
            'tables.styles' => 'phpbbkt_styles',
            'tables.styles_template' => 'phpbbkt_styles_template',
            'tables.styles_template_data' => 'phpbbkt_styles_template_data',
            'tables.styles_theme' => 'phpbbkt_styles_theme',
            'tables.styles_imageset' => 'phpbbkt_styles_imageset',
            'tables.styles_imageset_data' => 'phpbbkt_styles_imageset_data',
            'tables.teampage' => 'phpbbkt_teampage',
            'tables.topics' => 'phpbbkt_topics',
            'tables.topics_posted' => 'phpbbkt_topics_posted',
            'tables.topics_track' => 'phpbbkt_topics_track',
            'tables.topics_watch' => 'phpbbkt_topics_watch',
            'tables.user_group' => 'phpbbkt_user_group',
            'tables.user_notifications' => 'phpbbkt_user_notifications',
            'tables.users' => 'phpbbkt_users',
            'tables.warnings' => 'phpbbkt_warnings',
            'tables.words' => 'phpbbkt_words',
            'tables.zebra' => 'phpbbkt_zebra',
            ...
            'tables' => [
                'acl_groups' => 'phpbbkt_acl_groups',
                'acl_options' => 'phpbbkt_acl_options',
                'acl_roles' => 'phpbbkt_acl_roles',
                'acl_roles_data' => 'phpbbkt_acl_roles_data',
                'acl_users' => 'phpbbkt_acl_users',
                'attachments' => 'phpbbkt_attachments',
                'auth_provider_oauth_token_storage' => 'phpbbkt_oauth_tokens',
                'auth_provider_oauth_states' => 'phpbbkt_oauth_states',
                'auth_provider_oauth_account_assoc' => 'phpbbkt_oauth_accounts',
                'banlist' => 'phpbbkt_banlist',
                'bbcodes' => 'phpbbkt_bbcodes',
                'bookmarks' => 'phpbbkt_bookmarks',
                'bots' => 'phpbbkt_bots',
                'captcha_qa_questions' => 'phpbbkt_captcha_questions',
                'captcha_qa_answers' => 'phpbbkt_captcha_answers',
                'captcha_qa_confirm' => 'phpbbkt_qa_confirm',
                'config' => 'phpbbkt_config',
                'config_text' => 'phpbbkt_config_text',
                'confirm' => 'phpbbkt_confirm',
                'disallow' => 'phpbbkt_disallow',
                'drafts' => 'phpbbkt_drafts',
                'ext' => 'phpbbkt_ext',
                'extensions' => 'phpbbkt_extensions',
                'extension_groups' => 'phpbbkt_extension_groups',
                'forums' => 'phpbbkt_forums',
                'forums_access' => 'phpbbkt_forums_access',
                'forums_track' => 'phpbbkt_forums_track',
                'forums_watch' => 'phpbbkt_forums_watch',
                'groups' => 'phpbbkt_groups',
                'icons' => 'phpbbkt_icons',
                'lang' => 'phpbbkt_lang',
                'log' => 'phpbbkt_log',
                'login_attempts' => 'phpbbkt_login_attempts',
                'migrations' => 'phpbbkt_migrations',
                'moderator_cache' => 'phpbbkt_moderator_cache',
                'modules' => 'phpbbkt_modules',
                'notification_emails' => 'phpbbkt_notification_emails',
                'notification_types' => 'phpbbkt_notification_types',
                'notifications' => 'phpbbkt_notifications',
                'poll_options' => 'phpbbkt_poll_options',
                'poll_votes' => 'phpbbkt_poll_votes',
                'posts' => 'phpbbkt_posts',
                'privmsgs' => 'phpbbkt_privmsgs',
                'privmsgs_folder' => 'phpbbkt_privmsgs_folder',
                'privmsgs_rules' => 'phpbbkt_privmsgs_rules',
                'privmsgs_to' => 'phpbbkt_privmsgs_to',
                'profile_fields' => 'phpbbkt_profile_fields',
                'profile_fields_data' => 'phpbbkt_profile_fields_data',
                'profile_fields_options_language' => 'phpbbkt_profile_fields_lang',
                'profile_fields_language' => 'phpbbkt_profile_lang',
                'ranks' => 'phpbbkt_ranks',
                'reports' => 'phpbbkt_reports',
                'reports_reasons' => 'phpbbkt_reports_reasons',
                'search_results' => 'phpbbkt_search_results',
                'search_wordlist' => 'phpbbkt_search_wordlist',
                'search_wordmatch' => 'phpbbkt_search_wordmatch',
                'sessions' => 'phpbbkt_sessions',
                'sessions_keys' => 'phpbbkt_sessions_keys',
                'sitelist' => 'phpbbkt_sitelist',
                'smilies' => 'phpbbkt_smilies',
                'sphinx' => 'phpbbkt_sphinx',
                'styles' => 'phpbbkt_styles',
                'styles_template' => 'phpbbkt_styles_template',
                'styles_template_data' => 'phpbbkt_styles_template_data',
                'styles_theme' => 'phpbbkt_styles_theme',
                'styles_imageset' => 'phpbbkt_styles_imageset',
                'styles_imageset_data' => 'phpbbkt_styles_imageset_data',
                'teampage' => 'phpbbkt_teampage',
                'topics' => 'phpbbkt_topics',
                'topics_posted' => 'phpbbkt_topics_posted',
                'topics_track' => 'phpbbkt_topics_track',
                'topics_watch' => 'phpbbkt_topics_watch',
                'user_group' => 'phpbbkt_user_group',
                'user_notifications' => 'phpbbkt_user_notifications',
                'users' => 'phpbbkt_users',
                'warnings' => 'phpbbkt_warnings',
                'words' => 'phpbbkt_words',
                'zebra' => 'phpbbkt_zebra',
            ],
            'core.adm_relative_path' => 'adm/',
            'core.table_prefix' => 'phpbbkt_',
