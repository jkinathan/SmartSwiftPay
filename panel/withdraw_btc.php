									...
									<div class="row">
											...
											<div class="panel panel-white no-radius" id="visits">
												<div class="panel-heading border-light">
													<h4 class="panel-title"> BTC Withdrawal </h4>
												...
												<div collapse="visits" class="panel-wrapper">
													<div class="panel-body">
															...
															<input type="text" class="form-control" hint="Enter Amount (USD)" />
															
														</div>
														
															<div class="form-group">
															    
															  <p>We will send the Bitcoin equivalent to your wallet. <a href="https://www.blockchain.com/">Don't have bitcoin wallet yet? click here.</a></p>  
															   <p>Ensure you have updated your BTC wallet address in the settings page before you continue. <a href="settings">Click here if you haven't.</a></p>
														...
														<button class="btn btn-primary btn-wide pull-right" type="submit">
															Withdraw <i class="fa fa-arrow-circle-right"></i>
														</button>
													</div>
												</div>
											</div>
